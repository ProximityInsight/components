...
public class JarRuntimeInfoTest {
    ...
    /**
     * Test method for
     * {@link org.talend.components.api.component.runtime.DependenciesReader#extractDependencyFromStream(org.talend.components.api.component.runtime.DependenciesReader, java.lang.String, java.util.jar.JarInputStream)}
     * .
     * 
     * @throws IOException
    ...
    public void testExtracDependencyFromStream() throws MalformedURLException, IOException {
        ...
        try (JarInputStream jis = new JarInputStream(new FileInputStream(jarWithDeps))) {
            List<URL> dependencyFromStream = DependenciesReader.extractDependencyFromStream(new DependenciesReader(null),
